...
import board.tasks.persistence.dao.BlockDAO;
import board.tasks.persistence.dao.CardDAO;
import board.tasks.persistence.entity.CardEntity;
import board.tasks.exception.CardBlockedException;
import board.tasks.exception.CardFinishedException;
import board.tasks.exception.EntityNotFoundException;
...
import static board.tasks.persistence.entity.BoardColumnKindEnum.CANCEL;
import static board.tasks.persistence.entity.BoardColumnKindEnum.FINAL;
